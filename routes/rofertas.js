module.exports = function(app, swig, gestorBD) {
    ...
    app.post("/oferta", function (req, res) {
            ...
            if (oferta.nombre === null || oferta.nombre === undefined || oferta.nombre === '' ||
                ...
                res.redirect("/ofertas/agregar?mensaje=Checkea los campos");
            }

             else {
                gestorBD.insertarOferta(oferta, function (id) {
                    if (id == null) {
                        res.redirect("/publicaciones?mensaje=Oferta no añadida");
                    } else {
                            res.redirect("/publicaciones?mensaje=Se ha añadido la oferta");
                        }
